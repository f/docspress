...
Dry-run performs discovery, conversion, Page listing, comparison, conflict detection, and deletion planning. It assigns synthetic parent IDs for planned creates but does not call create, update, or delete endpoints.
